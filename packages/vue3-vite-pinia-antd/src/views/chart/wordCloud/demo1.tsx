...
import { WordCloudChart } from '@garron/vue3-chart';
import { fetchApi } from '../fetch';

export default defineComponent({
  name: 'ChartWordcloudDemo1',
  setup() {
    ...
    onMounted(async () => {
      const data1 = await fetchApi(
        'https://gw.alipayobjects.com/os/antfincdn/jPKbal7r9r/mock.json',
      );
      list1.data = data1;
